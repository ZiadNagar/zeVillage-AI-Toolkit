...
description: "Use this skill when applying behavioral science and persuasion principles to marketing, product design, pricing, and copy — covers 50+ mental models organized by buyer psychology, pricing, decision making, trust, urgency, and messaging."
...
1. **Definition** — what the principle is.
2. **Marketing Application** — how to apply it in practice.
3. **Implementation Example** — specific, concrete pattern.
4. **When to Use** — ideal context or scenario.
